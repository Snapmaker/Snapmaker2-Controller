...
class PowerLossRecovery {
    ...
    */
    ...
    void FORCE_INLINE SaveLaserInlineState(bool inline_state, bool trapezoid_power) {
			laser_inline_enable_ = inline_state;
			trapezoid_power_ = trapezoid_power;
    }
