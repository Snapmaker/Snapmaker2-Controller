...
enum SysControlOpc: uint8_t {
  ...
  SYSCTL_OPC_GET_NOZZLE_TYPE = 0x13,
  SYSCTL_OPC_GET_FILAMENT_STATE = 0x14,
  SYSCTL_OPC_GET_NOZZLE_TEMP = 0x15,
...
enum SettingsOpc: uint8_t {
  ...
  SETTINGS_OPC_EXTRUDER_STATUS_CTRL = 0x18,
  SETTINGS_OPC_START_STROKE_CALIBRATION,
  SETTINGS_OPC_STROKE_CONFIRM,
  SETTINGS_OPC_SET_HOTEND_OFFSET,
  SETTINGS_OPC_SET_FAN_SPEED,
  SETTINGS_OPC_XY_CALIBRATION,
  SETTINGS_OPC_XY_CALIBRATION_CONFIRM,
...
enum MotionOpc: uint8_t {
  ...
  MOTION_OPC_LEFT_STOPPER_ASSEMBLE,
  MOTION_OPC_RIGHT_STOPPER_ASSEMBLE,
