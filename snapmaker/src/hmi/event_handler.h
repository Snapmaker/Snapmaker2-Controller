...
enum SysControlOpc: uint8_t {
  ...
  SYSCTL_OPC_GET_HOTEND_TYPE = 0x13,
  SYSCTL_OPC_GET_FILAMENT_STATE = 0x14,
  SYSCTL_OPC_GET_HOTEND_TEMP = 0x15,
...
enum SettingsOpc: uint8_t {
  ...
  SETTINGS_OPC_TOOL_CHANGE    = 0x18,
  SETTINGS_OPC_GET_HOTEND_OFFSET = 0x19,
  SETTINGS_OPC_SET_HOTEND_OFFSET = 0x1b,
  SETTINGS_OPC_SET_FAN_SPEED  = 0x1c,
  SETTINGS_OPC_PROBE_SENSOR_CAL = 0x1d,
  SETTINGS_OPC_AUTO_BED_POSITION_DET = 0x1e,
  SETTINGS_OPC_MANUAL_BED_POSITION_DET = 0x1f,
  SETTINGS_OPC_DO_DUALEXTRUDER_AUTO_LEVELING = 0x20,
  SETTINGS_OPC_SET_DUALEXTRUDER_AUTO_LEVELING_POINT = 0x21,
  SETTINGS_OPC_FINISH_DUALEXTRUDER_AUTO_LEVELING = 0x22,
  SETTINGS_OPC_DO_DUALEXTRUDER_MANUAL_LEVELING = 0x23,
  SETTINGS_OPC_SET_DUALEXTRUDER_MANUAL_LEVELING_POINT = 0x24,
  SETTINGS_OPC_FINISH_DUALEXTRUDER_MANUAL_LEVELING = 0x25,
  SETTINGS_OPC_GET_ACTIVE_EXTRUDER = 0x26,

  //machine kit information
  SETTINGS_OPC_GET_MACHINE_KIT_INFO = 0x2b,
  SETTINGS_OPC_SET_MACHINE_KIT_INFO = 0x2c,

  SETTINGS_OPC_SET_CROSSLIGHT = 0x2d,
  SETTINGS_OPC_GET_CROSSLIGHT = 0x2e,
  SETTINGS_OPC_SET_FIRE_SENSOR_SENSITIVITY = 0x2f,
  SETTINGS_OPC_GET_FIRE_SENSOR_SENSITIVITY = 0x30,
  SETTINGS_OPC_SET_FIRE_SENSOR_REPORT_TIME = 0x31,
  SETTINGS_OPC_SET_CROSSLIGHT_OFFSET = 0x32,
  SETTINGS_OPC_GET_CROSSLIGHT_OFFSET = 0x33,
  SETTINGS_OPC_SET_WEAK_LIGHT_ORIGIN_MODE = 0x34,
  SETTINGS_OPC_GET_WEAK_POWER = 0x35,
  SETTINGS_OPC_SET_WEAK_POWER = 0x36,
...
enum MotionOpc: uint8_t {
  ...
  MOTION_OPC_DO_E_INFINITY_MOVE,
  MOTION_OPC_STOP_AXES_MOVE,
