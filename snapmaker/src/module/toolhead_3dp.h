...
#define SINGLE_RESUME_RETRACT_E_LENGTH                6.0
#define SINGLE_POWER_LOSS_RETRACT_E_LENGTH            2.0
#define DUAL_EXTRUDER_RESUME_RETRACT_E_LENGTH         1.5
#define DUAL_EXTRUDER_POWER_LOSS_RETRACT_E_LENGTH     1.5
