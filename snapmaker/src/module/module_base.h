...
enum ModuleFunctionID {
  ...
  MODULE_FUNC_GET_LASER_HOUSING_TEMP_TMP        ,  // 76
  MODULE_FUNC_SET_TEC_TEMP_TMP                  ,  // 77
...
const uint8_t module_prio_table[][2] = {
  ...
  {/* MODULE_FUNC_GET_LASER_HOUSING_TEMP_TMP */         MODULE_FUNC_PRIORITY_MEDIUM, 1},
  {/* MODULE_FUNC_SET_TEC_TEMP_TMP */                   MODULE_FUNC_PRIORITY_MEDIUM, 1},
};
