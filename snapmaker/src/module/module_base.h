...
enum ModuleFunctionID {
  ...
  MODULE_FUNC_GET_EMERGENCY_STOP_STA,  // 20
  MODULE_FUNC_PLACEHOLDER0          ,  // 21
  MODULE_FUNC_PLACEHOLDER1          ,  // 22

  MODULE_FUNC_SET_PURIFIER_PARAM    ,  // 23
  MODULE_FUNC_GET_PURIFIER_PARAM    ,  // 24
  MODULE_FUNC_SWITCH_EXTRUDER       ,  // 25
  MODULE_FUNC_MAX
};
...
const uint8_t module_prio_table[][2] = {
  ...
  {/* MODULE_FUNC_GET_EMERGENCY_STOP_STA*/MODULE_FUNC_PRIORITY_MEDIUM,    0},
  {/* MODULE_FUNC_PLACEHOLDER0        */  MODULE_FUNC_PRIORITY_MEDIUM,    0},
  {/* MODULE_FUNC_PLACEHOLDER1        */  MODULE_FUNC_PRIORITY_MEDIUM,    0},
  {/* MODULE_FUNC_SET_PURIFIER_STA    */  MODULE_FUNC_PRIORITY_MEDIUM,    0},
  {/* MODULE_FUNC_GET_PURIFIER_STA    */  MODULE_FUNC_PRIORITY_MEDIUM,    0},

  {/* MODULE_FUNC_SWITCH_EXTRUDER     */  MODULE_FUNC_PRIORITY_HIGH,      1}
};
