...
#define BOOT_PARA_SIZE	(6*1024)
#define MARLIN_POWERPANIC_SIZE  (4*1024)
...
#define FLASH_MARLIN	(FLASH_BOOT_PARA+BOOT_PARA_SIZE)
#define FLASH_MARLIN_POWERPANIC (FLASH_MARLIN+MARLIN_CODE_SIZE)
#define FLASH_MARLIN_EEPROM	(FLASH_MARLIN_POWERPANIC+MARLIN_POWERPANIC_SIZE)
#define FLASH_UPDATE_CONTENT_INFO  (FLASH_MARLIN_EEPROM + MARLIN_EEPROM_SIZE)
