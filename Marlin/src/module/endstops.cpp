...
void Endstops::init() {
   ...
   statefromcan |= (1<<Y2_MIN);
    ...
    #endif
  #else
   statefromcan |= (1<<Z_MIN);
  #endif

  #if DISABLED(CAN_ENDSTOP_Z2_MIN)
    #if HAS_Z2_MIN
      #if ENABLED(ENDSTOPPULLUP_ZMIN)
    ...
    #endif
  #else
   statefromcan |= (1<<Z2_MIN);
  #endif

  #if DISABLED(CAN_ENDSTOP_Z3_MIN)
    #if HAS_Z3_MIN
      #if ENABLED(ENDSTOPPULLUP_ZMIN)
   ...
   statefromcan |= (1<<Z3_MIN);
    ...
    #endif
  #else
   statefromcan |= (1<<X_MAX);
  #endif

  #if DISABLED(CAN_ENDSTOP_X2_MAX)
    #if HAS_X2_MAX
      #if ENABLED(ENDSTOPPULLUP_XMAX)
   ...
   statefromcan |= (1<<Y2_MAX);
    ...
    #endif
  #else
   statefromcan |= (1<<Z_MAX);
  #endif

  #if DISABLED(CAN_ENDSTOP_Z2_MAX)
    #if HAS_Z2_MAX
      #if ENABLED(ENDSTOPPULLUP_ZMAX)
    ...
    #endif
  #else
   statefromcan |= (1<<Z2_MAX);
  #endif

  #if DISABLED(CAN_ENDSTOP_Z3_MAX)
    #if HAS_Z3_MAX
      #if ENABLED(ENDSTOPPULLUP_ZMAX)
  ...
  #define ES_REPORT_CAN(S) print_es_state(((CanModules.Endstop & _BV(S)) == 0) == S##_ENDSTOP_INVERTING, PSTR(MSG_##S))
    ...
    ES_REPORT(Z3_MAX);
      ...
      for (uint8_t i = 1; i <= NUM_RUNOUT_SENSORS; i++) {
        ...
        #else
          print_es_state(TEST(CanModules.Endstop, FILAMENT1+i) != FIL_RUNOUT_INVERTING);
        #endif
      }
    #endif
  #endif
